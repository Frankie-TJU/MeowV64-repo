...
object DecodeInfo {
  ...
  val table: Array[(BitPat, List[BitPat])] =
    Array(
      ...
      FCVT_W_S  -> List(Y, N, Y, integer, Y, float, N, XX, N, XX, floatToInt, float),
      FCVT_WU_S -> List(Y, N, Y, integer, Y, float, N, XX, N, XX, floatToInt, float),
      FMV_X_W   -> List(Y, N, Y, integer, Y, float, N, XX, N, XX, floatToInt, float),
      FEQ_S     -> List(Y, N, Y, integer, Y, float, Y, float, N, XX, floatToInt, float),
