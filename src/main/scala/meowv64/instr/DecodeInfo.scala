...
object DecodeInfo {
  ...
  val table: Array[(BitPat, List[BitPat])] =
    Array(
      ...
      FEQ_D     -> List(Y, N, Y, integer, Y, float, Y, float, N, XX, floatToInt, float),
      FLT_D     -> List(Y, N, Y, integer, Y, float, Y, float, N, XX, floatToInt, float),
      FLE_D     -> List(Y, N, Y, integer, Y, float, Y, float, N, XX, floatToInt, float),
