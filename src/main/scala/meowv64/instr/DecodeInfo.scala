...
object DecodeInfo {
  ...
  val default: List[BitPat] =
    List(N, N, N, XX, N, XX, N, XX, N, XX, bypass, IQT.int)
  val table: Array[(BitPat, List[BitPat])] =
    Array(
      // RV32I Base Instruction Set
      LUI     -> List(Y, N, Y, integer, N, XX, N, XX, N, XX, bypass, IQT.int),
      AUIPC   -> List(Y, N, Y, integer, N, XX, N, XX, N, XX, bypass, IQT.int),
      JAL     -> List(Y, N, Y, integer, N, XX, N, XX, N, XX, bypass, IQT.int),
      JALR    -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, branch, IQT.int),
      BEQ     -> List(Y, N, N, XX, Y, integer, Y, integer, N, XX, branch, IQT.int),
      BNE     -> List(Y, N, N, XX, Y, integer, Y, integer, N, XX, branch, IQT.int),
      BLT     -> List(Y, N, N, XX, Y, integer, Y, integer, N, XX, branch, IQT.int),
      BGE     -> List(Y, N, N, XX, Y, integer, Y, integer, N, XX, branch, IQT.int),
      BLTU    -> List(Y, N, N, XX, Y, integer, Y, integer, N, XX, branch, IQT.int),
      BGEU    -> List(Y, N, N, XX, Y, integer, Y, integer, N, XX, branch, IQT.int),
      LB      -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, lsu, IQT.mem),
      LH      -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, lsu, IQT.mem),
      LW      -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, lsu, IQT.mem),
      LBU     -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, lsu, IQT.mem),
      LHU     -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, lsu, IQT.mem),
      SB      -> List(Y, N, N, XX, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      SH      -> List(Y, N, N, XX, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      SW      -> List(Y, N, N, XX, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      ADDI    -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, alu, IQT.int),
      SLTI    -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, alu, IQT.int),
      SLTIU   -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, alu, IQT.int),
      XORI    -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, alu, IQT.int),
      ORI     -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, alu, IQT.int),
      ANDI    -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, alu, IQT.int),
      SLLI    -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, alu, IQT.int),
      SRLI    -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, alu, IQT.int),
      SRAI    -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, alu, IQT.int),
      ADD     -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, alu, IQT.int),
      SUB     -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, alu, IQT.int),
      SLL     -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, alu, IQT.int),
      SLT     -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, alu, IQT.int),
      SLTU    -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, alu, IQT.int),
      XOR     -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, alu, IQT.int),
      SRL     -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, alu, IQT.int),
      SRA     -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, alu, IQT.int),
      OR      -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, alu, IQT.int),
      AND     -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, alu, IQT.int),
      FENCE   -> List(Y, N, N, XX, N, XX, N, XX, N, XX, lsu, IQT.mem),
      FENCE_I -> List(Y, N, N, XX, N, XX, N, XX, N, XX, lsu, IQT.mem),
      ECALL   -> List(Y, N, N, XX, N, XX, N, XX, N, XX, branch, IQT.int),
      EBREAK  -> List(Y, N, N, XX, N, XX, N, XX, N, XX, branch, IQT.int),
      CSRRW   -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, csr, IQT.int),
      CSRRS   -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, csr, IQT.int),
      CSRRC   -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, csr, IQT.int),
      CSRRWI  -> List(Y, N, Y, integer, N, XX, N, XX, N, XX, csr, IQT.int),
      CSRRSI  -> List(Y, N, Y, integer, N, XX, N, XX, N, XX, csr, IQT.int),
      CSRRCI  -> List(Y, N, Y, integer, N, XX, N, XX, N, XX, csr, IQT.int),

      // RV64I Base Instruction Set (in addition to RV32I)
      LWU   -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, lsu, IQT.mem),
      LD    -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, lsu, IQT.mem),
      SD    -> List(Y, N, N, XX, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      ADDIW -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, alu, IQT.int),
      SLLIW -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, alu, IQT.int),
      SRLIW -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, alu, IQT.int),
      SRAIW -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, alu, IQT.int),
      ADDW  -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, alu, IQT.int),
      SUBW  -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, alu, IQT.int),
      SLLW  -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, alu, IQT.int),
      SRLW  -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, alu, IQT.int),
      SRAW  -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, alu, IQT.int),

      // RV32M Standard Extension
      MUL    -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, mul, IQT.int),
      MULH   -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, mul, IQT.int),
      MULHSU -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, mul, IQT.int),
      MULHU  -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, mul, IQT.int),
      DIV    -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, div, IQT.int),
      DIVU   -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, div, IQT.int),
      REM    -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, div, IQT.int),
      REMU   -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, div, IQT.int),

      // RV64M Standard Extension (in addition to RV32M)
      MULW  -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, mul, IQT.int),
      DIVW  -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, div, IQT.int),
      DIVUW -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, div, IQT.int),
      REMW  -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, div, IQT.int),
      REMUW -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, div, IQT.int),

      // RV32A Standard Extension
      LR_W      -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, lsu, IQT.mem),
      SC_W      -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      AMOSWAP_W -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      AMOADD_W  -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      AMOXOR_W  -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      AMOAND_W  -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      AMOOR_W   -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      AMOMIN_W  -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      AMOMAX_W  -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      AMOMINU_W -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      AMOMAXU_W -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, lsu, IQT.mem),

      // RV64A Standard Extension (in addition to RV32A)
      LR_D      -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, lsu, IQT.mem),
      SC_D      -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      AMOSWAP_D -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      AMOADD_D  -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      AMOXOR_D  -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      AMOAND_D  -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      AMOOR_D   -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      AMOMIN_D  -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      AMOMAX_D  -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      AMOMINU_D -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      AMOMAXU_D -> List(Y, N, Y, integer, Y, integer, Y, integer, N, XX, lsu, IQT.mem),
      ...
      URET -> List(Y, N, N, XX, N, XX, N, XX, N, XX, branch, IQT.int),
      SRET -> List(Y, N, N, XX, N, XX, N, XX, N, XX, branch, IQT.int),
      MRET -> List(Y, N, N, XX, N, XX, N, XX, N, XX, branch, IQT.int),
      DRET -> List(Y, N, N, XX, N, XX, N, XX, N, XX, branch, IQT.int),

      // Interrupt-Management Instructions
      WFI -> List(Y, N, N, XX, N, XX, N, XX, N, XX, branch, IQT.int),

      // Memory-Management Instructions
      SFENCE_VMA -> List(Y, N, N, XX, Y, integer, Y, integer, N, XX, branch, IQT.int),

      // Vector
      VSETVLI  -> List(Y, N, Y, integer, Y, integer, N, XX, N, XX, csr, IQT.int),
      VSETIVLI -> List(Y, N, Y, integer, N, XX, N, XX, N, XX, csr, IQT.int),
